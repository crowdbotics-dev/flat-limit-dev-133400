"""
Django settings for flat_limit_dev_133400 project.
...
ROOT_URLCONF = 'flat_limit_dev_133400.urls'
...
WSGI_APPLICATION = 'flat_limit_dev_133400.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flat_limit_dev_133400 API",
    "DESCRIPTION": "API documentation for flat_limit_dev_133400 App",
    "VERSION": "v1",
}
